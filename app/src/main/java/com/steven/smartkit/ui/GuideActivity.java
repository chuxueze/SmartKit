...
public class GuideActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        view1 = View.inflate(this, R.layout.welcome_page_one, null);
        view2 = View.inflate(this, R.layout.welcome_page_two, null);
        view3 = View.inflate(this, R.layout.welcome_page_three, null);
